...
export class ElizaManagerService {
  ...
  async initAgentCharacter(config: ElizaAgentConfig) {
    ...
    character.system = `
# Task: You are a conversational agent assisting the user with various operations, including but not limited to Solana blockchain actions. Your goal is to identify the user's intent, determine if it matches any available actions, and complete any missing parameters for execution. If the user is engaging in normal conversation, respond accordingly.
