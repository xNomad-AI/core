...
export class ElizaManagerService {
  ...
  async initAgentCharacter(config: ElizaAgentConfig) {
    ...
    character.knowledge.push(
      'I am an AI Agent running in TEE, I am generated by xNomad AI-NFT',
    );
    character.knowledge.push(
      'I support Solana token trading now, I will support evm soon, and other blockchains in the future',
    );
    character.knowledge.push(
