...
async function createAndBuyToken({
    ...
    try {
        ...
        elizaLogger.log("Creating token with metadata:", deployer.publicKey.toBase58(), mint.publicKey.toBase58(), tokenMetadata, buyAmountSol, priorityFee, allowOffCurve, slippage);
...
export default {
    ...
    handler: async (
        ...
        try {
            ...
            const rpcUrl = runtime.getSetting("SOLANA_RPC_URL") || settings.SOLANA_RPC_URL || "https://api.mainnet-beta.solana.com";
